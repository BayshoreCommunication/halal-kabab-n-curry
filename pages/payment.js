...
function Payment() {
  ...
  return (
    <>
     <Head>
        <title>Delivera | Payment |  Food Delivery and Takeout | Order Online</title>
        ...
        <Row>
          <Col lg="6" md="6" sm="12" className="m-auto text-center">
            <form className="form mb-3" onSubmit={submitHandler}>
              ...
              <button type="button" className="addTOCart__btn bg-secondary" onClick={() =>router.push('/shipping')}>
                Back
              </button>
            </form>
          </Col>
