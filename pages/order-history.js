...
function OrderHistory() {
  ...
  return (
    <>
      <Head>
        <title>Delivera | Order History | Food Delivery and Takeout | Order Online</title>
                              ...
                              <tbody>
                                  {
                                      orders.map((order)=>(
                                          ...
                                          <td> <Link href={`/order/${order._id}`} passHref legacyBehavior><button className="bg-danger addTOCart__btn">Details</button></Link></td>
                                        </tr>
                                      ))
                                  }
                              </tbody>
