...
import CheckoutWizard from "../components/checkoutWizard";
 function checkout() {
  ...
  return (
    <>
       <Head>
        <title>Delivera | Shipping |  Food Delivery and Takeout | Order Online</title>
        ...
        <Container>
          <Row>
            <Col lg="8" md="6">
              ...
              <form className="checkout__form" onSubmit={handleSubmit(submitHandler)}>
                    ...
                    type="text"
                    {
                        ...register(
                          'fullName', {
                            ...
                            minLength: {value: 4, message: 'Full Name is more than 3'}
                          }
                        )
                      }
                    ...
                    type="text"
                    {
                        ...register(
                          'address', {
                            ...
                            minLength: {value: 4, message: 'Full address is more than 3'}
                          }
                        )
                      }
                ...
                <div className="form__group">
                  <button type="button" className="upload__btn" onClick={chooseLocationHandler}>Choose on Map</button>
                  <div className="text-danger">{location && `${location.lat},${location.lng}`}</div>
                </div>
