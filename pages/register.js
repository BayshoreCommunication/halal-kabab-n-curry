...
const Register = () => {
  ...
  return (
    <>
      <Head>
      <Head>
      <title>Delivera | Register | Food Delivery and Takeout | Order Online</title>
        ...
        <Container>
          <Row>
            <Col lg="6" md="6" sm="12" className="m-auto text-center">
              ...
              <Link href="/login" legacyBehavior><a className="link__color mb-4">Already have an account? Login</a></Link>
            </Col>
          </Row>
        </Container>
      </section>
